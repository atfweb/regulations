...
import Tutorial from './tutorial-view';
...
const NextPrevView = require('./nextprev-view');
const CitationFixView = require('./citationFix-view');
...
const MainView = Backbone.View.extend({
  ...
  loading: function loading() {
    ...
    $('.main-content').addClass('loading');
      //Timeout added for browser failures that prevent loading class removal at the 'loaded' method
    setTimeout(function(){
