...
const PrintSectionView = require('../sidebar/printSection-view');
const ExplosivesCalcView = require('../sidebar/explosivesCalc-view')
const DiffOnlyView = require('../sidebar/diffOnly-view');
