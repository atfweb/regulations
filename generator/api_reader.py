...
def _fetch(suffix, params=None):
    ...
    """Python version 3.9+ creates an issue with JSON configuration."""
    ...
    if response.status_code == requests.codes.ok:
        try:
            ...
            logger.warning('JSON formatting error (Possible result of python version upgrade)')
    ...
    def regulation(self, label, version):
        ...
        if cached is not None:
            ...
            try:
                ...
                try:
                    regulation = _fetch('regulation/{}'.format(label))
